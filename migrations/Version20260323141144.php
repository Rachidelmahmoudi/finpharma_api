 ...
 */
final class Version20260323141144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pharmacies (id VARCHAR(255) NOT NULL, name VARCHAR(150) NOT NULL, address VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, reference VARCHAR(255) DEFAULT NULL, category VARCHAR(255) DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, google_maps_url VARCHAR(255) DEFAULT NULL, town VARCHAR(100) DEFAULT NULL, email VARCHAR(50) DEFAULT NULL, is_always_open TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
